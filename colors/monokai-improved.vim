...
"call s:HL('semshiParameter',                s:cyan, '', '')
"call s:HL('semshiParameterUnused',          s:cyan, '', '')
...
"call s:HL('semshiUnresolved',               s:gray5, '', '')
"call s:HL('semshiSelected',                 '', '', '')
"call s:HL('semshiErrorSign',                s:gray5, '', '')
"call s:HL('semshiErrorChar',                s:gray5, '', '')
...
call s:HL('pythonFString',                  s:yellow, '', '')
call s:HL('pythonUniRawString',             s:yellow, '', '')
call s:HL('pythonRawString',                s:yellow, '', '')
call s:HL('pythonRawFString',               s:yellow, '', '')
call s:HL('pythonRawBytes',                 s:yellow, '', '')
call s:HL('pythonBytes',                    s:yellow, '', '')
...
call s:HL('pythonImport',                   s:red, '', '')
call s:HL('pythonInclude',                  s:purple, '', '')
call s:HL('pythonFunction',                 s:green, '', '')
call s:HL('pythonFunctionCall',             s:green, '', '')
call s:HL('pythonClassVar',                 s:orange, '', '')
...
call s:HL('pythonError',                    s:brown, '', '')
call s:HL('pythonIndentError',              s:brown, '', '')
call s:HL('pythonSpaceError',               s:brown, '', '')
call s:HL('pythonBraces',                   s:gray5, '', '')
call s:HL('pythonParens',                   s:gray5, '', '')
call s:HL('pythonBuiltinFunc',              s:cyan, '', '')
call s:HL('pythonBuiltinType',              s:purple, '', '')
call s:HL('pythonBuiltinObj',               s:purple, '', '')
call s:HL('pythonExClass',                  s:orange, '', '')
call s:HL('pythonDocTest',                  s:yellow, '', '')
call s:HL('pythonDocTest2',                 s:yellow, '', '')
