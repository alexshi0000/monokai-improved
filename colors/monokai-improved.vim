...
call s:HL('pythonClassStatement',           s:purple, '', '')
...
call s:HL('pythonClassname',                s:purple, '', '')
...
call s:HL('pythonParens',                   s:cyan, '', '')
call s:HL('pythonOpSymbols',                s:red, '', '')
call s:HL('pythonLogicSymbols',             s:red, '', '')

call s:HL('pythonVariable',                 s:gray5, '', '')
call s:HL('pythonObject',                   s:purple, '', '')
call s:HL('pythonCall',                     s:cyan, '', '')
call s:HL('pythonInstance',                 s:cyan, '', '')
